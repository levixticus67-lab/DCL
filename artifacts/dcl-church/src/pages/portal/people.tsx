...
type Role = "pastor" | "minister" | "member";
...
export default function PeoplePage() {
  ...
  return (
    <PortalLayout>
      <PortalHeader
        title="People"
        subtitle="Pastors, ministers and members of DCL"
        actions={
          editable ? (
            <Button
              onClick={openCreate}
            ...
            >
              <div className="flex items-start gap-4">
                ...
                <div className="flex-1 min-w-0">
                  <div className="font-serif text-lg text-[hsl(215,80%,22%)] truncate">
                    {p.fullName}
                  </div>
              ...
              {branch && (
                <div className="text-xs text-[hsl(215,40%,40%)] mt-3">
                  {branch.name}
                </div>
              )}
              ...
              <Field label="Leader">
                <div className="h-10 flex items-center gap-2 px-3 rounded-md border bg-white/50">
                  <Switch
                    ...
                    onCheckedChange={(v) =>
                      setForm({ ...form, isLeader: v })
                    }
                    data-testid="switch-isleader"
                  />
                  <span className="text-sm">
                    {form.isLeader ? "Yes" : "No"}
                  </span>
                </div>
              </Field>
            </div>
